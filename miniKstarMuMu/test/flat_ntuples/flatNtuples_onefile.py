...
sys.path.append('/gwpool/users/fiorendi/p5prime/run3/CMSSW_15_0_6/src/miniB0KstarMuMu/miniKstarMuMu')
...
tree_lmnr.Add('/gwpool/users/fiorendi/p5prime/run3/CMSSW_15_0_6/src/miniB0KstarMuMu/miniKstarMuMu/test/B0ToKstMuMu_miniaod_newFile_50kevents.root')
# tree_lmnr.Add('/gwpool/users/fiorendi/p5prime/run3/CMSSW_15_0_6/src/miniB0KstarMuMu/miniKstarMuMu/test/B0ToKstMuMu_miniaod_newFile_50kevents_udpate.root')
file_out = ROOT.TFile( 'ntuple_flat_ourNtuple.root', 'recreate')
...
for i, ev in enumerate(tree_lmnr):
    ...
    muon_pairs_hlt = list(itertools.product(hlt_mums,hlt_mups))
    ...
    for icand in range(len(ev.bMass)):
        ...
        charge_matched = 99
        charge_matched = findTriggerMatchingRun3(muon_pairs_hlt,
...
#         l1_00_OS[0]                    = findFiringL1(ev.L1Table, ev.L1Prescales, 'L1_DoubleMu0er1p6_dEta_Max1p8_OS')
        ...
        kstTrkmDCABSSign[0]            = abs(ev.kstTrkmDCABS[icand]/ev.kstTrkmDCABSE[icand])
        ...
        kstTrkpDCABSSign[0]            = abs(ev.kstTrkpDCABS[icand]/ev.kstTrkpDCABSE[icand])
