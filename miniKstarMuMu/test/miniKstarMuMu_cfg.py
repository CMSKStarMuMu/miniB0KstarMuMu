...
#         'root://cms-xrd-global.cern.ch//store/mc/RunIIFall17MiniAODv2/BdToKstarMuMu_BMuonFilter_SoftQCDnonD_TuneCP5_13TeV-pythia8-evtgen/MINIAODSIM/PU2017_12Apr2018_N1_94X_mc2017_realistic_v14-v1/20000/08D2B3E9-0043-E811-B981-C4346BC78D10.root'
...
process.B0KstMuMu = cms.EDAnalyzer("miniKstarMuMu",
    ...
    MuMuLsBS         = cms.untracked.double(0.5),    # mu-mu L/sigma w/respect to BS [3.0]
    ...
    MuEta            = cms.untracked.double(2.5),    # mu max eta [2.4]
    ...
    B0VtxCL          = cms.untracked.double(0.001),  # B0 Vtx CL [0.01]
    ...
    HadpT            = cms.untracked.double(0.6),    # hadron min pT [0.8 GeV/c] (also in HLT)
...
process.p = cms.Path(process.B0KstMuMu)
